...
const docTemplate = `{
    ...
    "paths": {
        "/products": {
            ...
            "post": {
                "description": "This API allows you to create a new product by providing its details in the request body.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
        ...
        "/products/{productID}": {
            "get": {
                "description": "his API retrieves the details of a single product based on the provided product ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
